...
:root {
  ...
  --shadow-sm: 0 1px 3px 0 rgb(0 0 0 / 0.04),         /* Card default */
               0 1px 2px -1px rgb(0 0 0 / 0.04);
  --shadow-md: 0 4px 6px -1px rgb(0 0 0 / 0.05),      /* Card hover */
  ...
  theme: {
    extend: {
      colors: {
        ...
        surface: {
          background: 'rgb(from var(--surface-background) r g b / <alpha-value>)',
        ...
        text: {
          ...
          placeholder: 'rgb(from var(--text-placeholder) r g b / <alpha-value>)',
        ...
        border: {
          ...
          interactive: 'rgb(from var(--border-interactive) r g b / <alpha-value>)',
        },
        damage: {
