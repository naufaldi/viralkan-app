...
Viralkan's design system prioritizes **clarity, accessibility, and civic engagement**. As a public service platform for reporting road damage, the interface must be:

- **Immediately intuitive** for all users regardless of technical literacy
- **Highly accessible** following WCAG 2.1 AA standards
- **Mobile-first** as most reports will come from phones on-site
- **Performance-optimized** to work on slower connections
- **Trustworthy** conveying government/civic reliability
