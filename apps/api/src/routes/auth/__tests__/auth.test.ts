...
describe('Auth Core Logic Tests', () => {
  test('validateFirebaseToken should validate token format', () => {
    ...
    const validToken = 'eyJhbGciOiJSUzI1NiIsImtpZCI6InRlc3QifQ.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWV9.test'
  ...
  test('environment variable validation', () => {
    const requiredVars = ['DATABASE_URL', 'JWT_SECRET', 'FIREBASE_SERVICE_ACCOUNT_JSON']
