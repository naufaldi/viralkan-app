      ...
      <div className="container mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16 space-y-6">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-slate-900 leading-tight">
            Platform kami memberdayakan Anda untuk membuat perubahan nyata
            melalui{" "}
            ...
            return (
              ...
              >
                <CardHeader className="pb-4">
                  {/* Icon */}
                  <div
                    className={`inline-flex w-14 h-14 rounded-2xl bg-gradient-to-r ${prop.gradient} p-3 shadow-lg mb-4 group-hover:scale-110 transition-transform duration-300`}
                  >
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-3">
                    {prop.features.map((feature, featureIndex) => (
                      ...
                      >
                        <div
                          className={`w-2 h-2 rounded-full bg-gradient-to-r ${prop.gradient}`}
                        ></div>
                ...
                {/* Decorative Elements */}
                <div
                  className={`absolute top-0 right-0 w-24 h-24 bg-gradient-to-br ${prop.gradient} opacity-5 rounded-full -translate-y-12 translate-x-12 group-hover:scale-150 transition-transform duration-700`}
                ></div>
                <div
                  className={`absolute bottom-0 left-0 w-16 h-16 bg-gradient-to-br ${prop.gradient} opacity-5 rounded-full translate-y-8 -translate-x-8 group-hover:scale-125 transition-transform duration-500`}
                ></div>
              </Card>
            );
          })}
