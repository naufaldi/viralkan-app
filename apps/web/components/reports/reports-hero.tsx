...
import { Search, Plus, Users, AlertTriangle, TrendingUp, MapPin } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-10 lg:mb-12 gap-4 lg:gap-6">
            <div className="flex items-center gap-3">
              <Badge variant="secondary" className="bg-neutral-100 text-neutral-700 border-neutral-200 px-3 py-1 rounded-md">
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-base sm:text-lg text-neutral-600 leading-relaxed">
                  "Dari masyarakat, untuk masyarakat" — Platform komunitas untuk 
                  melaporkan dan berbagi informasi kerusakan jalan di seluruh Indonesia.
                </p>
              </div>
