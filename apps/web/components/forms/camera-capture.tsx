  ...
  useEffect(() => {
    ...
    const startCamera = async () => {
      try {
        ...
        // Request camera access - MDN approach with flexible constraints
    ...
    <div className="space-y-4">
      ...
      <Card className="overflow-hidden border border-neutral-200 shadow-md">
        <CardContent className="p-0">
          <div className="relative bg-neutral-900" style={{ aspectRatio: 'auto' }}>
      ...
      <div className="text-center">
        <p className="text-sm text-neutral-600">
          Position camera on damaged road and press camera button to take photo
        </p>
      </div>
    </div>
  );
